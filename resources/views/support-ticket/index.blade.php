...
@section('web_title', 'Solicitudes Asignadas')

@section('title')
    <i class="fa-solid fa-ticket"></i> Solicitudes Asignadas
@endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table  class="table table-hover" id="supportTicket-table" style="width:100%">
                            <thead>
                                <tr>
...
@push('js')
    <script>
        var route_registros = '{{ route("ticket.support.get") }}'
    </script>

    <script src="{{asset('assets/dist/js/supportTicket-table.js')}}"></script>
