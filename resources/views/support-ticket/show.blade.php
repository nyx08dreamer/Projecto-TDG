...
@section('web_title', 'Detalles de la Solicitud')

@section('title')
    <i class="fa-solid fa-file-circle-plus"></i> Detalles de la Solicitud
@endsection
...
<div class="row">
    <div class="col-12">
        ...
        <div class="float-right pb-3">
            <a href="{{ route('ticket.support.index') }}" class="btn btn-primary">
                Regresar
            </a>
        </div>
    </div>
