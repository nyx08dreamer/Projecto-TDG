...
@section('web_title', 'Creación de Departamento')

@section('title')
    <i class="fa-solid fa-circle-exclamation"></i> Creación de Departamento
@endsection
...
@section('content')
    <div class="row">
        <div class="col-12">
            <form id="department-create" method="post" action="{{ route('config.department.store')}}">
                @csrf
