...
@section('web_title', 'Solicitudes Archivadas')

@section('title')
    <i class="fa-solid fa-ticket"></i> Solicitudes Archivadas
@endsection

@section('breadcrumbs')
    <li class="breadcrumb-item active"><a href="{{ route('gestion.archived-tickets.index') }}">Solicitudes Archivadas</a></li>
@endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table  class="table table-hover" id="archived-table" style="width:100%">
                            <thead>
                                <tr>
...
@push('js')
    <script>
        var route_registros = '{{ route("gestion.archived-tickets.get") }}'
    </script>

    <script src="{{asset('assets/dist/js/archived-table.js')}}"></script>
