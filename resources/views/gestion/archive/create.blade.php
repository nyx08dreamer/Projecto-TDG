...
@section('title')
    <i class="fa-solid fa-file-circle-plus"></i> Archivar Solicitudes
@endsection
...
@section('content')
    <div class="row">
        <div class="col-12">
            <form id="ticket-assign" method="post" action="{{ route('gestion.archive.ticket') }}">
                @csrf
                @method('PATCH')
                    ...
                    <div class="float-right pb-3">
                        <a href="{{ route('gestion.archive.index') }}" class="btn btn-outline-danger">Cancelar</a>
